public class Polyline extends OpenFigure{
    ...
    @Override public Polyline shift(Point2D a) {
        for (Point2D e : p) e.add(a); return this;
    }
    @Override public Polyline rot(double phi) {
        for (Point2D e : p) e.rot(phi); return this;
    }
    @Override public Polyline symAxis(int i) {
        for (Point2D e : p) e.symAxis(i); return this;
    }
    ...
    @Override public String toString() {
        ...
        for (Point2D e : p) sb.append(e.toString() + " ");
        sb.append(" ]");
        return sb.toString();
    }
}
